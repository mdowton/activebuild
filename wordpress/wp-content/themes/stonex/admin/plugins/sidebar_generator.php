...
class sidebar_generator {
	...
	function admin_menu(){
		add_submenu_page('themes.php', 'Sidebars', 'Sidebars', 'manage_options', '/admin/plugins/sidebar_generator.php', array('sidebar_generator','admin_page'));
	}
...
function save_form($post_id){
	 $_POST['sbg_edit'] = isset($_POST['sbg_edit']) ? $_POST['sbg_edit'] : $_POST['sbg_edit'] = null;
