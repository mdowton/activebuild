...
define( 'NOTIFIER_THEME_NAME', 'Stonex Premium Wordpress Theme' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'stonex' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.skatdesign.com/stonex/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
